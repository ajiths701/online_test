...
Class name 		: Fizz Buzz Bazz Series class
...
class number_series{
	...
	/*
	Purpose 	: Function is to display Fizz Buzz series for an integer range 
	...
	*/
	public function fizzBuzzSeries($start_no, $end_no){
		...
		//check the start number is positive.
		$chk_no	=	$this->checkPositive($start_no);
	...
	/*
	Purpose 	: Function is to display Fizz Buzz Bazz series for an integer range 
	Parameters 	: starting interger,ending integer
	...
	*/	
	public function fizzBuzzBazzSeries($start_no, $end_no){
		...
		//initialize status_flag_bazz to 0
		//This flash use to display Bazz  after consecutive Fizzes/Buzzes
		$status_flag_bazz = 0;
	...
	/*
	Purpose 	: Function is to check whether the given number is positive integer range 
	Parameters 	: starting interger
	
	Eg: function(-2)
	Output : Please input positive integer range
	*/
	public function checkPositive($start_no){
	
		if($start_no < 0){
			print "Please input positive integer range";
			return false;
		}else{
			return true;
		}	
